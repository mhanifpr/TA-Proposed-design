  ...
  return (
    <div className="relative bg-white w-full h-[2011px] overflow-y-auto text-left text-29xl text-black font-poppins">
      ...
      <div className="absolute top-[93px] left-[42px] w-[1398px] h-[489px] text-mini">
        <div className="absolute top-[5.52%] left-[0%] text-45xl leading-[48px] font-bold">
          Overview
        </div>
      ...
      <div className="absolute top-[722px] left-[66px] w-[1308px] h-[428px] text-5xl">
        ...
        <div className="absolute top-[10.51%] left-[39.14%] text-29xl leading-[48px] font-extrabold">
          Utopia-Game
        </div>
        <div className="absolute h-[14.25%] w-[59.4%] top-[28.74%] left-[20.87%] text-mini tracking-[-0.02em] font-medium text-center inline-block">
      ...
      <div className="absolute top-[1464px] left-[66px] w-[999px] flex flex-col items-start justify-start gap-[20px]">
        <div className="relative leading-[48px] font-bold">Heading 1</div>
      ...
      <div className="absolute top-[17px] left-[1361px] leading-[48px] font-extrabold">{`#1 `}</div>
      <div className="absolute top-[652px] left-[37px] leading-[48px] font-extrabold">
        #2
      </div>
      <div className="absolute top-[1355px] left-[1361px] leading-[48px] font-extrabold">
        #3
      </div>
      <Link
