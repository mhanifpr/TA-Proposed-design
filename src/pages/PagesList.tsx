...
const PagesList: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1519px] overflow-hidden text-left text-5xl text-black font-poppins">
      ...
      <div className="absolute top-[1071px] left-[330px] tracking-[-0.02em] leading-[25px] font-semibold">
        Personlity Details:
      </div>
      ...
      <div className="absolute top-[1106px] left-[331px] bg-white box-border w-[349px] h-[375px] text-base font-roboto border-[1px] border-solid border-black">
      ...
      <div className="absolute top-[1106px] left-[694px] bg-white box-border w-[349px] h-[375px] text-[inherit] font-inherit border-[1px] border-solid border-black">
        <div className="absolute top-[0px] left-[0px] bg-gainsboro-300 box-border w-[349px] h-[61px] border-[1px] border-solid border-black" />
      ...
      <div className="absolute top-[1106px] left-[1057px] bg-white box-border w-[349px] h-[375px] text-[inherit] font-inherit border-[1px] border-solid border-black">
        <div className="absolute top-[0px] left-[0px] bg-gainsboro-300 box-border w-[349px] h-[61px] border-[1px] border-solid border-black" />
        <div className="absolute top-[123.66px] left-[30.91px] tracking-[0.15px] leading-[150%] inline-block w-[303.13px] h-[187.99px]">
          <ul className="m-0 pl-[19px]">
            <li className="mb-0">-20% Military Casualties</li>
